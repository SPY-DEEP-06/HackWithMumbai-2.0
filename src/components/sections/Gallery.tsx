        ...
        <section className="overflow-hidden bg-darkhold relative z-20">
            <div ref={triggerRef}>
                <div ref={sectionRef} className="h-screen w-[400vw] flex flex-row relative">
                    ...
                    {/* Title Panel */}
                    <div className="w-screen h-full flex flex-col items-center justify-center px-20 border-r border-white/10 relative">
                        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-20"></div>
                        <h2 className="text-8xl font-cinematic text-transparent bg-clip-text bg-gradient-to-r from-tva to-scarlet mb-8">
                            THE ARCHIVES
                        </h2>
                        <p className="font-retro text-xl text-gray-400">
                            Recovered footage from previous timelines.
                        </p>
                        <div className="mt-12 animate-bounce text-loki">
                    ...
                    {images.map((src, index) => (
                        <div key={index} className="w-screen h-full flex items-center justify-center p-20 border-r border-white/5 relative">
                            <div className="relative group w-full max-w-4xl aspect-video transform transition-transform hover:scale-105 duration-500">
                                ...
                                />
                                <div className="absolute bottom-4 right-4 font-retro text-tva text-sm bg-black/80 px-2 py-1">
                                    IMG_SEQ_00{index + 1}
                                </div>
                            </div>
                        </div>
